...
EXTRA_TRANSLATIONS: dict[str, str] = {
    ...
    "Právní forma příjemce pro osvobození": "Recipient legal form for the exemption",
    "Chybí potvrzení, zda příjemce splňuje podmínku kvalifikované právní formy pro vnitrostátní osvobození dividend.": "Confirmation is missing that the recipient satisfies the qualifying legal-form condition for the domestic dividend exemption.",
    "Jurisdikce příjemce pro osvobození": "Recipient jurisdiction for the exemption",
    "Je nutné potvrdit, že příjemce je rezidentem jurisdikce způsobilé pro vnitrostátní osvobození dividend.": "It must be confirmed that the recipient is resident in a jurisdiction eligible for the domestic dividend exemption.",
    "Zdanění příjemce pro osvobození": "Recipient taxation for the exemption",
    "Chybí potvrzení, že příjemce podléhá kvalifikované dani z příjmů právnických osob ve státě své rezidence.": "Confirmation is missing that the recipient is subject to a qualifying corporate income tax in its state of residence.",
    "Daňové osvobození nebo nulová sazba příjemce": "Recipient tax exemption or zero-rate status",
    "Chybí potvrzení, že příjemce není od kvalifikované daně osvobozen ani nepodléhá režimu s nulovou sazbou.": "Confirmation is missing that the recipient is neither exempt from the qualifying tax nor subject to a zero-rate regime.",
    "Postavení mateřské společnosti": "Parent-company status",
    "Zadané údaje nepotvrzují, že jsou pro osvobození splněny podmínky kvalifikované mateřské společnosti.": "The entered facts do not confirm that the qualifying parent-company conditions for the exemption are met.",
    "Budoucí splnění doby držby": "Future satisfaction of the holding period",
    "Pro tuto větev osvobození chybí potvrzení, že bude dosažena požadovaná minimální doba držby.": "For this exemption branch, confirmation is missing that the required minimum holding period will be reached.",
    "Postup při dodatečném splnění doby držby": "Procedure for subsequent satisfaction of the holding period",
    "Chybí údaj potřebný pro posouzení režimu při dodatečném splnění minimální doby držby.": "A fact required to assess the regime for subsequent satisfaction of the minimum holding period is missing.",
