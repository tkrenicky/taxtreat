...
'''
    ...
    page3_title = "Practical follow-up and supporting documents" if english else "Navazující povinnosti a podklady"
    page3_copy = "Deadlines, supporting documentation and additional legal sources relevant to the transaction." if english else "Lhůty, dokumentace a další právní zdroje relevantní pro posuzovanou transakci."
