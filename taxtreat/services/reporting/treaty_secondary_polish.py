...
<article class="legal-source tt-treaty-secondary">
  ...
  <div class="quote">
    <strong>English reading aid:</strong> the applicable dividends article limits Czech taxing rights. In this result, however, the treaty is not the primary legal basis because the Czech domestic exemption under Section 19 applies first.
  </div>
