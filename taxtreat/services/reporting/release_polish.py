...
.page{width:210mm;min-height:297mm;height:auto;padding:6mm;background:var(--page-bg)}
.sheet{min-height:285mm;height:auto;padding:11mm 12mm 9mm;background:var(--paper);border:0;border-radius:4.5mm;box-shadow:0 1px 3px rgba(0,0,0,.06);overflow:visible}
...
.head-meta{color:var(--label);font-size:7.3px;line-height:1.35}
...
.hero .kicker,.section-head .kicker{margin-bottom:2mm;color:var(--navy-soft);font-size:6.6px;letter-spacing:.09em}
.hero h1{margin:0 0 2mm;color:var(--navy);font:600 27px/1.28 var(--serif);letter-spacing:0}
.hero p{max-width:145mm;margin:0;color:var(--label);font-size:9px;line-height:1.45}
...
.key-fact span{color:var(--label);font-size:6.2px;text-transform:uppercase;letter-spacing:.04em}
...
.rate{margin:.7mm 0 3.6mm;color:var(--navy);font:700 44px/1 var(--serif);letter-spacing:0}
.basis-row,.fact-row,.calc-row,.assumption-row{padding:2mm 0;border-top:1px solid rgba(27,42,74,.10);font-size:8.7px}
...
.conclusion{margin-top:3mm;padding-top:0;border-top:0;color:var(--body);font-size:8.6px;line-height:1.55}
.path-note{margin-top:3mm;padding:2.6mm 3.5mm;border-left:3px solid var(--navy);border-radius:0 2mm 2mm 0;background:rgba(255,255,255,.55);color:var(--navy);font-size:8.5px;line-height:1.48}
...
.assumption-note{margin:1.6mm 0 0!important;color:var(--label);font-size:7.7px;font-style:italic;line-height:1.5}
.assumptions-grid{display:flex;flex-wrap:wrap;justify-content:space-between;column-gap:0}
.assumption-row{width:47%;font-size:8.5px}
...
.calc-row{width:47%;font-size:8.6px}
.calc-row:nth-child(-n+2){border-top:0}
.calc-row.net b{color:var(--navy);font-size:8.8px}
.fx{margin-top:2mm;padding-top:2mm;border-top:1px solid var(--card-border);color:var(--label);font-size:7.5px}

.flow-wrap{
  margin:0;
  padding:5.5mm 6mm 4.8mm;
...
.flow-node:last-child b{
  font-size:8.2px
}
.flow-node:last-child p{
  margin-top:2mm;
  color:var(--navy);
...
.section-head p{margin:0;color:var(--label);font-size:9px;line-height:1.45}
...
.quote{padding:3.6mm 4mm;border-left:3px solid var(--navy);border-radius:0 2mm 2mm 0;background:var(--accent-fill);color:var(--body);font-size:8.8px;line-height:1.62}
.quote strong{color:var(--navy);font-weight:700}
.transaction-gloss{margin-top:3mm;padding:2.6mm 3.5mm;border-radius:2mm;background:rgba(27,42,74,.05);color:var(--body);font-size:8px;line-height:1.52}
.transaction-gloss b{color:var(--navy)}
.legal-note{margin:2mm 0 0;color:var(--label);font-size:7.4px;line-height:1.45}

.page:nth-of-type(2) .sheet{display:block}
.page:nth-of-type(2) .section-head{display:block}
.page:nth-of-type(2) .legal-source{display:block}
...
.deadline-card span{color:var(--navy);font-size:8.2px;font-weight:700}
.deadline-card b{margin-top:.7mm;color:var(--navy);font:700 17px/1.2 var(--serif)}
.deadline-card p{margin:1mm 0 0;color:var(--label);font-size:7.7px;line-height:1.5}
...
.mini-card li{margin-bottom:1.5mm;color:var(--body);font-size:8px;line-height:1.5}
...
.hierarchy-note{margin-top:5.5mm;padding:4mm 5mm;border-left:3px solid var(--navy);border-radius:0 2mm 2mm 0;background:var(--accent-fill);color:var(--body);font-size:8px;line-height:1.55}
.hierarchy-note b{margin-bottom:1.3mm;color:var(--navy);font:600 13.5px/1.2 var(--serif)}
.disclaimer{margin-top:6.5mm;padding-top:3.5mm;border-top:1px solid var(--card-border);color:var(--label);font-size:6.7px;line-height:1.5}
.footer{position:static;margin-top:7mm;padding-top:3mm;border-top:1px solid var(--card-border);color:var(--label);font-size:7px}
...
def _apply_final_copy(html: str) -> str:
    replacements = {
        ...
        "Od českého pravidla ke konečnému režimu": (
            "Od českého pravidla ke konečné sazbě"
        ),
