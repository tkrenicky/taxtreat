(() => {
  ...
  loadScript("/ui-assets/workspace-cz-relief-i18n.js?v=20260820-4")
    ...
    .then(() => loadScript("/ui-assets/workspace-en-final-residue2-20260826.js?v=20260826-enfinal4"))
    .then(() => loadScript("/ui-assets/workspace-en-stabilizer-20260826.js?v=20260826-enstable3"))
    .then(() => loadScript("/ui-assets/workspace-result-integrity-20260826.js?v=20260826-integrity1"))
    .catch((problem) => {
