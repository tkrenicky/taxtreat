(() => {
  ...
  const COUNTRY_CONTEXT = Object.freeze({
    ...
    SK: Object.freeze({
      ...
      taxResultLabelWithCurrency: "Zrážková daň v EUR",
      taxResultLabelEn: "Slovak withholding tax",
      taxResultLabelWithCurrencyEn: "Slovak withholding tax in EUR",
      complianceTitle: "Rozhodujúci dátum a nadväzujúce lehoty",
      ...
      notificationLabel: "Oznámenie príjmu plynúceho do zahraničia",
      ...
      prereleaseNotice: "",
      complianceNoteDefault: "Lehoty sa zobrazia po dokončení výpočtu.",
