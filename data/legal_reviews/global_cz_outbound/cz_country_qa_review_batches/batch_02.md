...
Risk focus: material_protocol_overlay, multiple_historical_instruments, wht_relevant_mli_modification.
...
Audit package hash: `37cb27e7b2b0bf2b79972911edc9cc6a107394d713070754b8caaea0a92a8276`.

Human QA: **PENDING**. Reviewer: ____  Date: ____  Outcome: ____  Independent review (if required): ____

## BG — Bulharsko (ELEVATED)
...
Audit package hash: `6b73f179fc2c01ca076713a9afb88b7506c80322f7208d529541283209dca1d3`.
...
Audit package hash: `bec29d4e5ae24ba33585470c567f2f6e64652a8a60b4eb268a99e9ddf9ef5555`.
...
| interest | 11 | 0.0%, 10.0%, 15.0% | 10.0%: beneficial_owner == true; 15.0%: beneficial_owner == true; 0.0%: beneficial_owner == true |
| royalty | 12 | 15.0%, 25.0% | 25.0%: beneficial_owner == true; 15.0%: beneficial_owner == true |
...
Audit package hash: `b090f7deac79e7bf12df3e24805c35e07feef86853f0dbb87f7e598028dd85bb`.
...
|---|---:|---:|---|
| dividend | 10 | 5.0% | 5.0%: beneficial_owner == true |
| interest | 11 | 0.0%, 7.5% | 7.5%: beneficial_owner == true; 0.0%: beneficial_owner == true |
...
Audit package hash: `42b22327098e9e8188524dc6243a9962734d7a06d855417eb6a9faa0fa93c6d9`.
...
Audit package hash: `9b93f16609d7acc61ba2179274c7a9a905e1b1bd26eaa9a432f44116b413ea6d`.
...
| Income | Article | Candidate rate(s) | Material candidate conditions |
|---|---:|---:|---|
| dividend | 10 | 5.0%, 15.0% | 5.0%: minimum_ownership >= 10, beneficial_owner == true; 15.0%: beneficial_owner == true; 5.0%: beneficial_owner == true |
...
Audit package hash: `f11ecb343087b9d41a8d2a3f4832c12ce3c15c82f63c042b8fb7caace0ac91c9`.
...
| Income | Article | Candidate rate(s) | Material candidate conditions |
|---|---:|---:|---|
| dividend | 10 | 0.0%, 15.0% | 15.0%: recipient_is_treaty_resident == True, beneficial_owner == True, permanent_establishment_connection == False; 0.0%: recipient_is_treaty_resident == True, beneficial_owner == True, recipient_entity_type == company, recipient_is_partnership == False, ownership_percent >= 10, holding_period_months >= 12, permanent_establishment_connection == False; 0.0%: recipient_is_treaty_resident == True, beneficial_owner == True, recipient_entity_type == qualifying_pension_fund, permanent_establishment_connection == False; 0.0%: recipient_is_treaty_resident == True, beneficial_owner == True, recipient_entity_type == central_bank, permanent_establishment_connection == False |
...
Audit package hash: `428bafe2cb48dd194fa541064deebfb432c896235a4b359eb43645ece96f45ef`.
...
Risk focus: multiple_historical_instruments, wht_relevant_mli_modification.

| Income | Article | Candidate rate(s) | Material candidate conditions |
|---|---:|---:|---|
| dividend | 10 | 15.0% | 15.0%: beneficial_owner == true |
| interest | 11 | 4.0%, 15.0% | 4.0%: beneficial_owner == true; 15.0%: beneficial_owner == true |
| royalty | 12 | 5.0%, 10.0% | 5.0%: beneficial_owner == true; 10.0%: beneficial_owner == true |
...
Audit package hash: `354bad0513223b467f9475ea3b0209e30fc33367a4ea856d3967d6dfac69009c`.
...
Audit package hash: `f97e9989a17b6dcfb0475c4f7d53317264ddbec329f4c649bb0c5f85cdab57d7`.
