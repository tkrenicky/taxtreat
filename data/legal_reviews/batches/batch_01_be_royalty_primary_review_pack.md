# Primary legal review – CZ → BE / royalty

**Packet:** `CZ-BE-ROY-LEGAL-REVIEW`

**Review hash:** `656a3b80e1602e09889a081aecef0c49847296fbbfb84a4df6b0d91370d8b047`

## 1. Základní smlouva

- Publikace: 95/2000 Sb.m.s.
- Článek: 12 – LICENČNI POPLATKY
- Source ID: `SRC-E16828A7660D9797`
- Stav: `needs_review`

### Kandidátní smluvní sazby

- **5.0 %** — Article 12 — beneficial_owner == true
- **10.0 %** — Article 12 — beneficial_owner == true
...
```json
{
  ...
  "legal_reference": "section 19(1)(zj), (3), (5)-(8) and section 38nb",
  "rate": 0.0,
...
### 1. Which royalty categories are subject to the 5% rate?

- Odpověď: `[ANO / NE]`
- Právní odůvodnění:
- Supporting source IDs:

### 2. Which royalty categories are subject to the 10% rate?

- Odpověď: `[ANO / NE]`
- Právní odůvodnění:
- Supporting source IDs:

### 3. Does the treaty definition include software, know-how, industrial equipment or copyright separately?

- Odpověď: `[ANO / NE]`
- Právní odůvodnění:
- Supporting source IDs:

### 4. Does the protocol leave Article 12 unchanged?

- Odpověď: `[ANO / NE]`
- Právní odůvodnění:
- Supporting source IDs:

### 5. Are the Czech IRD conditions and section 38nb requirement correctly represented?
