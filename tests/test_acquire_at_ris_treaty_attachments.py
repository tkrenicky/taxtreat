...
def test_ris_landing_page_discovers_german_and_english_treaty_text_pdfs_only(monkeypatch, tmp_path: Path):
    ...
    html = f"""
    <html><body>
      <a href="{german}" title="Signiertes PDF-Dokument: deutscher Vertragstext" class="iconOnlyLink"><img alt="Signiertes PDF-Dokument" /></a>
      <a href="{english}" title="Signiertes PDF-Dokument: englischer Vertragstext samt Protokoll" class="iconOnlyLink"><img alt="Signiertes PDF-Dokument" /></a>
      <a href="{french}" title="Signiertes PDF-Dokument: französischer Vertragstext" class="iconOnlyLink"><img alt="Signiertes PDF-Dokument" /></a>
      <a href="{german}" title="Signiertes PDF-Dokument: deutscher Vertragstext" class="iconOnlyLink"><img alt="Signiertes PDF-Dokument" /></a>
    </body></html>
    """.encode()
...
def test_ris_current_view_discovers_full_consolidated_pdf(monkeypatch, tmp_path: Path):
    ...
    html = f'<html><body><a href="{consolidated}" title="PDF-Dokument: Doppelbesteuerung Albanien, Fassung vom 24.08.2026"><img alt="PDF-Dokument" /></a></body></html>'.encode()
